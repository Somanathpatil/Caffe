            ...
            <div className='container max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-8 '>
                ...
                <div className='w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left px-4 md:px-7'>
                        ...
                        <p className='text-base sm:text-lg md:text-xl leading-relaxed mb-6'> 
                            Bean scene is a coffee shope that provides you with quality coffee that helps boost your productivity and build your mood. Having a cup of coffee is good, but having a cup of real coffee is greater. There is doubt that you will enjoy this coffee more than any other you have ever tasted.  
                        </p>
                ...
                <div className='w-full md:w-1/2 flex justify-center md:justify-end items-center px-4 '>
                    <img src={CoffeeBeans} alt="CoffeeBeans" className='w-full h-auto max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl object-contain ' />
                </div>
